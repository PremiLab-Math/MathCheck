...
# def task2prompt_deepseek(task, question, task_prompt, solution = None, judgement = None, few_shot = True, img_path=None, encode_img_base64=False):
#     if "nshot" not in task_prompt[task].keys():
#         few_shot = False
#     system_prompt = task_prompt[task]["system-prompt"]
#     if task == "solving":
...
#             for shot in task_prompt[task]["nshot"]:
#                 nshot += "Question: " + shot["Question"] + "\nAnswer: " + shot["Answer"] + "\n\n"
#             user_prompt = task_prompt[task]["user-prompt"] +"\n\n"+ task_prompt["deepseek-prompt"] + nshot
#         else:
#             user_prompt = task_prompt[task]["user-prompt"]
#         user_prompt += "\nQuestion: " + question + "\nAnswer: "
